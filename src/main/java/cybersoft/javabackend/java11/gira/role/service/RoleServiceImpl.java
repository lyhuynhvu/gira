...
public class RoleServiceImpl implements RoleService {
	...
	public List<Role> findByRoleName(String roleName){
		return _repository.findByRoleName("role-name");
	}

	@Override
	public List<Role> findByDescription(String décription) {
		return _repository.findByDescriptionContainingOrderByIdAsc("desrciption");
	}
